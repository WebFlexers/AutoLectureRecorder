...
public partial class SettingsView : ReactiveUserControl<SettingsViewModel>
{
    public SettingsView()
    {
        ...
        this.WhenActivated(disposables =>
        {
            ...
            this.Bind(ViewModel, 
                    ...
                    v => v.OnStartupToggleButton.IsChecked)
                .DisposeWith(disposables);
            this.Bind(ViewModel, 
                    vm => vm.GeneralSettings.OnCloseKeepAlive, 
                    v => v.OnCloseMinimizeToggleButton.IsChecked)
                .DisposeWith(disposables);

            // Recording Settings
            // Video
            this.OneWayBind(ViewModel, 
                    vm => vm.SupportedScreenResolutions, 
                    v => v.OutputResolutionCombobox.ItemsSource)
                .DisposeWith(disposables);

            this.Bind(ViewModel, 
                    vm => vm.RecordingSettings.RecordingsLocalPath, 
                    v => v.RecordingPathTextBox.Text)
                .DisposeWith(disposables);
            this.Bind(ViewModel, 
                    vm => vm.RecordingSettings.Quality, 
                    v => v.QualityTextBox.Text)
                .DisposeWith(disposables);
            this.Bind(ViewModel, 
            ...
            this.Bind(ViewModel, 
                    ...
                    v => v.OutputResolutionCombobox.Text,
                    this.ConvertResolutionToString, this.ConvertStringToResolution)
                .DisposeWith(disposables);

            this.BindCommand(ViewModel, 
                    vm => vm.BrowseDirectoryCommand, 
                    v => v.BrowseRecordingDirectoryButton)
                .DisposeWith(disposables);

            // Audio
            this.Bind(ViewModel, 
                    vm => vm.RecordingSettings.IsInputDeviceEnabled, 
                    v => v.RecordAudioToggleButton.IsChecked)
                .DisposeWith(disposables);
            this.OneWayBind(ViewModel, 
                    vm => vm.InputAudioDevices, 
                    v => v.InputDeviceCombobox.ItemsSource)
                .DisposeWith(disposables);
            this.OneWayBind(ViewModel, 
                    vm => vm.OutputAudioDevices, 
                    v => v.OutputDeviceCombobox.ItemsSource)
                .DisposeWith(disposables);
            this.Bind(ViewModel, 
                    vm => vm.SelectedInputDevice, 
                    v => v.InputDeviceCombobox.Text,
                    this.ConvertAudioDeviceToString, this.ConvertStringToAudioDevice)
                .DisposeWith(disposables);
            this.Bind(ViewModel, 
                    vm => vm.SelectedOutputDevice, 
                    v => v.OutputDeviceCombobox.Text,
                    this.ConvertAudioDeviceToString, this.ConvertStringToAudioDevice)
                .DisposeWith(disposables);
        });
    }
    ...
    {
        return audioDevice?.FriendlyName is not null 
